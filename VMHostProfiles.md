...
* For KVM hosts, the names must match network interface names or Virtual Network names (Virtual Network names added in 2.5)
...
<img src="images/network-only-no-repo.gif" width="400" border="1">
